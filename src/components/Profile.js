...
this.intApp()
  ...
  intApp() {
    ...
    fetch("http://44.202.98.199:9000/get_user_by_id", requiredOptions)
  ...
  UpdateUserhandleSubmit = e => {
    ...
    fetch("http://44.202.98.199:9000/update_user", requiredOptions)
    .then((response) => response.json())
    .then(personDetail => {
      console.log(personDetail)
  ...
  UpdatePasshandleSubmit = e => {
    ...
    fetch("http://44.202.98.199:9000/update_user_password", requiredOptions)
    .then((response) => response.json())
    .then(personDetail => {
      console.log(personDetail)
      this.setState({ isLoading: false })
...
curencySubmit = e => {
  ...
  fetch("http://44.202.98.199:9000/create_other_wallet", requiredOp)
    .then((response) => response.json())
    .then(personDetail => {
      console.log(personDetail)
      this.setState({ isLoading: false })
...
updateProfilePic = e => {
  ...
  axios.put("http://44.202.98.199:9000/profile_update", data, requiredOp)
  .then((response) => {
